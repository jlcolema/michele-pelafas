...
<section id="content" class="full-width">
	...
	<div class='blogListingHeading-block'>
		<div class='blogListingHeading-inner'>
			<span class='heading-sm-gold blogListing-smallHeading'>FROM ME TO YOU, XO MICHELE</span>
			<h2 class='blogListing-largeHeading'>BEAUTY BLOG LISTING PAGE</h2>
			<p class='blogListing-textBody'><!--Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.--></p>
		</div>
	</div>
